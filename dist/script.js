...
/* harmony import */ var _modules_calcCost__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/calcCost */ "./src/js/modules/calcCost.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_calcCost__WEBPACK_IMPORTED_MODULE_5__["default"])('#size', '#material', '#options', '.promocode', '.calc-price');
  Object(_modules_images__WEBPACK_IMPORTED_MODULE_6__["default"])('.sizes-block');
});

/***/ }),

/***/ "./src/js/modules/calcCost.js":
/*!************************************!*\
  !*** ./src/js/modules/calcCost.js ***!
  \************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var calcCost = function calcCost(size, material, options, promo, result) {
  ...
  function calcPrice() {
    var sum = +sizeBox.value * +materialBox.value + +optionsBox.value;
...
/* harmony import */ var _services_requests__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../services/requests */ "./src/js/services/requests.js");
...
var forms = function forms() {
  ...
  allForms.forEach(function (form) {
    form.addEventListener('submit', function (e) {
      ...
      var path;
      formParent.closest('.popup-design') || formParent.closest('.calc') ? path = './assets/server.php' : path = './assets/question.php';
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_16__["postData"])(path, data).then(function (res) {
  ...
  function clearInputs() {
    [].concat(_toConsumableArray(allInputs), _toConsumableArray(allTextArea)).forEach(function (item) {
      return item.value = '';
    });
    filesInput.forEach(function (item) {
...
var images = function images(elem) {
  var allImg = document.querySelectorAll(elem);
...
var mask = function mask(selector) {
  ...
  allInputs.forEach(function (input) {
    ...
    input.addEventListener('selectionchange', function () {
      console.log('caret position', _this.selectionStart);
    });
  });
};
...
var modals = function modals() {
  ...
  function bindModal(targetSelector, modalSelector, closeSelector) {
    ...
    var trigger = document.querySelectorAll(targetSelector),
...
var showMoreStyles = function showMoreStyles(trigger, parent) {
...
var sliders = function sliders(slider, dir, prev, next) {
  var sliderIndex = 1;
  var autoSlide;
  var sliderGroup = document.querySelectorAll(slider);
  ...
  function showSlide(i) {
    ...
    sliderGroup.forEach(function (item) {
  ...
  sliderGroup[0].parentNode.addEventListener('mouseenter', function () {
    clearInterval(autoSlide);
  });
  sliderGroup[0].parentNode.addEventListener('mouseleave', function () {
    activateSlider();
  });
};
